    ...
    content = {
        ...
        "L": {
            "summary": (
                ...
                "docs/handoffs/active/, passing verify-agent-handoffs.ps1."
            ),
            "evidence": [
        ...
        "M": {
            "summary": (
                "Version aligned: `VERSION` 1.8.0 matches install manifest and the engine is 2.22.53; "
                "`pack/docs/AUDIT_SYSTEM_CHANGELOG.md` documents 2.22.53 (root cleanup; folder-aware install exclusion), 2.22.52 (one word for the handoff "
        ...
        "N": {
            "summary": (
                ...
                "2.22.0 through 2.22.10 -> 2.22.45 -> 2.22.46 -> 2.22.47 -> 2.22.48 -> 2.22.49 -> 2.22.50 -> 2.22.51 -> 2.22.52 -> 2.22.53 with a changelog entry per bump in "
